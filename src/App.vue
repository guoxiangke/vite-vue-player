...
export default {
    ...
    setup(){
        ...
        const audios = ref([
            {name: 'Silver Spirit',file: 'h', artist: 'Loading' ,howl: null},
        ]);
        const step =  ref(0);
        ...
        <div class="flex flex-col w-full bg-gray-100 border-b border-b-red-500">
          ...
          <div class="flex w-4/5 m-auto justify-between items-center mt-8 mb-4">
            <div class="text-grey-darker hover:bg-gray-300 rounded-full p-1">
              <svg @click="random = !random" :class="random ? 'text-red-500':''" class="w-8 h-8 cursor-pointer" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <div class="text-grey-darker hover:bg-gray-300 rounded-full p-1">
              <svg @click="prevButton ? previous() : ''" class="w-8 h-8 cursor-pointer" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <div class="text-white p-4 rounded-full bg-gradient-to-r from-red-500 via-red-600 to-red-700 shadow-lg">
              ...
              <svg v-else @click="pause()" class="w-8 h-8 cursor-pointer" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path d="M5 4h3v12H5V4zm7 0h3v12h-3V4z"/>
              </svg>
            </div>
            <div class="text-grey-darker hover:bg-gray-300 rounded-full p-1">
              <svg @click="nextButton ? next() : ''" class="w-8 h-8 cursor-pointer" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path d="M13 5h3v10h-3V5zM4 5l9 5-9 5V5z"/>
              </svg>
            </div>
            <div class="text-grey-darker hover:bg-gray-300 rounded-full p-1">
              <svg  @click="repeat = !repeat" :class="repeat ? 'text-red-500':''" class="w-8 h-8 cursor-pointer" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
